    ...
    <div class="gamePlay">
                    ...
                    <div class="box-wrapper mt-8">
                        <div class="box flex flex-col py-8">
                            <div class="ml-20 flex justify-end mx-2">
                                <button class="btn mx-2" @click="toggleTutorialMode('general')" :class="{
                                    'bg-orange-500': tutorial >= 5,
                                    'bg-gray-500': tutorial < 5,
                                }">
                                    <p>General</p>
                                </button>
                                <button class="btn mx-2" @click="toggleTutorialMode('gameMode')" :class="{
                                    ...
                                    <div class="md:w-1/2 flex flex-col items-center justify-center">
                                        <div class="text-lg text-black text-justify mb-4 md:mb-8 p-6 font-sans font-medium">
                                            ...
                                            <i class="text-pink-600">
                                                separated by at least one blank square.</i>The order of the numbers
                            ...
                            <div class="button-group self-center flex flex-row justify-items-end">
        ...
        <section id="gamePage">
            <div class="container px-10 pb-3 m-auto w-full" v-if="show == 2">
                <div class="header p-2 flex justify-center py-3">
                    <div v-show="mode === 'easyMode'" class="font-extrabold HeaderName ">easy mode</div>
                    <div v-show="mode === 'hardMode'" class="font-extrabold HeaderName ">hard mode</div>
                </div>
                <section class="flex items-center justify-between">
                    <div class="text-center align-middle shadow-md w-45 bg-base-200 p-2 py-4 font-sans font-semibold order-first"
                ...
                <div class="join flex justify-center">
                    <table class="hanjie-table">
                        <tr v-for="block in blocks" :key="block.row" :id="block.row" :style="checkTR(block.row)"
                            ...
                            <td ref="playCellElements" :class="checkHeaderStyle(col + block.row)"
                                v-for="col in block.column" :key="col + block.row" :id="col + block.row"
                                @click="addClickers" @click.right="mark">
                        ...
                        <div class="m-1 rounded-2xl p-4 font-bold" :class="healthStatus">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                <div class="bg-teal-500 h-2.5 rounded-full"
                                    :style="{ width: (1 - missed / fails) * 100 + '%' }"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col items-center justify-center">
                        <div class="box-wrapper2 mt-12">
                            <div
                                ...
                                <div class="Time text-justify mx-16 my-5 font-sans text-lg font-medium">
                                ...
                                <div v-show="!newBestTime">
                                    ...
                                    <button class="btn bg-green-400 hover:bg-green-900 hover:text-white text-black mx-3"
                                        type="button" @click="() => {
                                            gamePage()
                                            resetMiss()
                                        }
                        ...
                        <div class="mt-10">
                            <button class="btn bg-pink-600 hover:bg-pink-900" @click="homePage">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="24"
                                    height="24">
                                    <path d="M12 3L4 9v12h5v-7h6v7h5V9L12 3z" />
                                </svg>
                                <span class="text-white">Home</span>
                ...
                <div class="flex flex-col items-center justify-center">
                    <div class="box-wrapper2 mt-12">
                        <div
                            ...
                            <div class="text-justify mx-16 my-5 font-sans text-xl font-medium text-gray-700">
                                You've missed
                    ...
                    <div class="button-group mt-12 flex">
                        <button class="btn bg-pink-600 hover:bg-pink-900 mx-3" @click="homePage">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="24" height="24">
                                <path d="M12 3L4 9v12h5v-7h6v7h5V9L12 3z" />
                            </svg>
                            <span class="text-white">Home</span>
                        </button>
                        <button v-show="mode === 'hardMode'" @click="() => {
                            gamePage()
                            resetMiss()
                            hardMode()
                        }
                        ...
                        <button v-show="mode === 'easyMode'" @click="() => {
                            gamePage()
                            resetMiss()
                            ezMode()
                        }
